...
Pod::Spec.new do |s|
  ...
  # s.license      = "MIT"
  s.license      = { :type => "MIT", :file => "https://github.com/nsrandom/injector/blob/master/LICENSE" }
  ...
  # s.author             = { "Asif Sheikh" => "mail@asif.in" }
  s.author               = "NSRandom"
  # s.authors            = { "Asif Sheikh" => "mail@asif.in" }
  # s.social_media_url   = "http://twitter.com/Asif Sheikh"
  ...
  s.source       = { :git => "https://github.com/nsrandom/injector.git", :tag => "0.0.1" }
